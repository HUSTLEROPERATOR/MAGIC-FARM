...
export const AUDIT_ACTIONS = {
  ...
  // Mentalism engine
  MENTALISM_FIRMA_LOCKED: 'MENTALISM_FIRMA_LOCKED',
  MENTALISM_FIRMA_REVEALED: 'MENTALISM_FIRMA_REVEALED',
  MENTALISM_THOUGHT_SUBMITTED: 'MENTALISM_THOUGHT_SUBMITTED',
  MENTALISM_MEMORIA_SAVED: 'MENTALISM_MEMORIA_SAVED',
  MENTALISM_IDENTITY_REVEALED: 'MENTALISM_IDENTITY_REVEALED',
} as const;
