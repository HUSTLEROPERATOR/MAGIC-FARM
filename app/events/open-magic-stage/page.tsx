          ...
          <div className="card-magic">
            ...
            <div className="space-y-4 text-white/80">
              <div className="flex items-start gap-4">
                <Icon name="Theater" size="lg" className="text-magic-mystic shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Icon name="Timer" size="lg" className="text-magic-mystic shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Icon name="Users" size="lg" className="text-magic-mystic shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Icon name="Sparkles" size="lg" className="text-magic-mystic shrink-0" />
                <div>
          ...
          <div className="card-magic border-magic-gold/30">
            ...
            <div className="space-y-4 text-white/80">
              <div className="p-4 bg-white/5 rounded-lg">
                <h3 className="text-magic-mystic font-semibold mb-2 flex items-center gap-2"><Icon name="FileText" size="sm" /> Materiale Originale</h3>
                <p>È richiesto materiale originale o con diritti autorizzati. Rispetta sempre la proprietà intellettuale.</p>
              </div>
              <div className="p-4 bg-white/5 rounded-lg">
                <h3 className="text-magic-mystic font-semibold mb-2 flex items-center gap-2"><Icon name="AlertTriangle" size="sm" /> Sicurezza</h3>
                <p>Nessun numero pericoloso senza preventiva autorizzazione dell&apos;organizzazione.</p>
              </div>
              <div className="p-4 bg-white/5 rounded-lg">
                <h3 className="text-magic-mystic font-semibold mb-2 flex items-center gap-2"><Icon name="Clock" size="sm" /> Rispetto dei Tempi</h3>
                <p>Il limite di 10 minuti deve essere rigorosamente rispettato per garantire spazio a tutti i performer.</p>
              </div>
              <div className="p-4 bg-white/5 rounded-lg">
                <h3 className="text-magic-mystic font-semibold mb-2 flex items-center gap-2"><Icon name="Ban" size="sm" /> Contenuti Appropriati</h3>
                <p>Divieto assoluto di contenuti offensivi, discriminatori o inappropriati.</p>
              </div>
              <div className="p-4 bg-white/5 rounded-lg">
                <h3 className="text-magic-mystic font-semibold mb-2 flex items-center gap-2"><Icon name="Camera" size="sm" /> Privacy e Diritti d&apos;Immagine</h3>
      ...
      <section className="py-10 px-6 border-t border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          <Link href="/dashboard" className="text-magic-mystic hover:text-magic-gold transition-colors">
            <Icon name="ArrowLeft" size="xs" className="inline" /> Torna alla Dashboard
          </Link>
        </div>
      </section>
    </div>
  ...
  if (success) {
    return (
      <div className="card-magic text-center bg-green-500/10 border-green-500/30">
        <Icon name="CheckCircle" size="3xl" className="mx-auto mb-4 text-green-400" />
